...
import wiiv.emporium.client.render.tile.RenderTileCabinetTopSingle;
...
public class BlockCabinetTopSingle extends BlockBase {

	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);

	public BlockCabinetTopSingle() {
		super(Material.WOOD, "cabinet_top_single", 1.0F);
		setSoundType(SoundType.WOOD);
		GameRegistry.registerTileEntity(TileCabinetTopSingle.class, Globals.MOD_ID + ":TileCabinetTopSingle");
	}
	...
	public void initModel() {
		ModelRegistryHelper.registerItemRenderer(Item.getItemFromBlock(this), new RenderTileCabinetTopSingle());
		ModelRegistryHelper.setParticleTexture(this, RenderTileCabinetTopSingle.CABINET_SPRITE);
		ClientRegistry.bindTileEntitySpecialRenderer(TileCabinetTopSingle.class, new RenderTileCabinetTopSingle());
	}
	...
	public TileCabinetTopSingle getTE(World world, BlockPos pos) {
		return (TileCabinetTopSingle) world.getTileEntity(pos);
	}
	...
	public void onBlockClicked(World world, BlockPos pos, EntityPlayer player) {
		...
		if (side != EnumFacing.UP && side != EnumFacing.DOWN) {
			...
			if (slot > 0) {
				...
				TileCabinetTopSingle tile = getTE(world, pos);
	...
	public boolean mergeHeldItem(EntityPlayer player, EnumHand hand, World world, BlockPos pos) {
		...
		if (world.getTileEntity(pos) != null && world.getTileEntity(pos) instanceof TileCabinet) {
			...
			TileCabinetTopSingle tile = (TileCabinetTopSingle) world.getTileEntity(pos);
			IInventory inv = tile;
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileCabinetTopSingle();
	}
