...
public class BlockCandleChandelierColorable extends BlockBaseColorable16 implements ICacheableBlock {

	public static boolean fallInstantly;

	public BlockCandleChandelierColorable(int color) {
		super(Material.ANVIL, "candle_chandelier_colorable", 1.0F, color);
		setLightLevel(0.75F);
