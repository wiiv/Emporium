...
public class BlockMedievalBench extends BlockBase {
	...
	private static final AxisAlignedBB BOUNDING_BOX2 = new AxisAlignedBB((0.0625D * 3), 0.0D, (0.0625D * 1), (0.0625D * 13), (0.0625D * 10), (0.0625D * 15));
	...
	private static final AxisAlignedBB COLLISION_BOX2 = new AxisAlignedBB((0.0625D * 3), 0.0D, (0.0625D * 1), (0.0625D * 13), (0.0625D * 10), (0.0625D * 15));
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ) {
		return MountableUtil.sitOnBlock(worldIn, pos, playerIn, 0.45);
	}
