...
public class BlockStoneBench extends BlockBase {

	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	public static final PropertyBool LEFT = PropertyBool.create("left");
	public static final PropertyBool RIGHT = PropertyBool.create("right");
	private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB((0.0625D * 1), 0.0D, (0.0625D * 3), (0.0625D * 15), (0.0625D * 8), (0.0625D * 13));
	private static final AxisAlignedBB BOUNDING_BOX2 = new AxisAlignedBB((0.0625D * 3), 0.0D, (0.0625D * 0), (0.0625D * 13), (0.0625D * 8), (0.0625D * 16));
	private static final AxisAlignedBB COLLISION_BOX = new AxisAlignedBB((0.0625D * 1), 0.0D, (0.0625D * 3), (0.0625D * 15), (0.0625D * 8), (0.0625D * 13));
	private static final AxisAlignedBB COLLISION_BOX2 = new AxisAlignedBB((0.0625D * 3), 0.0D, (0.0625D * 0), (0.0625D * 13), (0.0625D * 8), (0.0625D * 16));

	public BlockStoneBench() {
		super(Material.ROCK, "stone_bench", 1.0F);
