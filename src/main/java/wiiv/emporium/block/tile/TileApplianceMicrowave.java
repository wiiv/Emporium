...
public class TileApplianceMicrowave extends TileEntity {
	...
	public TileApplianceMicrowave() {
         ...
         */
        asm = Emporium.proxy.load(new ResourceLocation(Globals.MOD_ID, "asms/block/appliance_microwave.json"), ImmutableMap.<String, ITimeValue>of("click_time", clickTime));
    }
