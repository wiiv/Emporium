...
public class BlockCandleCandelabraColorable extends BlockBaseColorable16 implements ICacheableBlock {

	public BlockCandleCandelabraColorable(int color) {
		super(Material.ANVIL, "candle_candelabra_colorable", 1.0F, color);
