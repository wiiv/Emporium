...
public class BlockApplianceMicrowave extends BlockBase {

	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	
	public BlockApplianceMicrowave() {
		super(Material.WOOD, "appliance_microwave", 1.0F);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if(worldIn.isRemote) {
            ...
            if(te instanceof TileApplianceMicrowave) {
                ((TileApplianceMicrowave)te).click();
            }
        }
        return true;
    }
    ...
    public TileEntity createNewTileEntity(@Nonnull World worldIn, int meta) {
        return new TileApplianceMicrowave();
    }
}
