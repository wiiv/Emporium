...
public class BlockStoolBarCushion extends BlockBaseColorable8 {

	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB((0.0625D * 4), 0.0D, (0.0625D * 4), (0.0625D * 12), (0.0625D * 12), (0.0625D * 12));
	...
	public BlockStoolBarCushion(int color) {
		super(Material.IRON, "stool_bar_cushion", 1.0F, color);
